...
export function ArticlePagination({ total, pageSize }: PaginationProps) {
  ...
  return (
    <Pagination aria-label="pagination">
      <Head>
        ...
        {currentPage !== 1 ? (
          <link rel="prev" href={`${createPageURL(currentPage - 1)}`} />
        ) : null}
        {!isLastPage ? (
          <link rel="next" href={`${createPageURL(currentPage + 1)}`} />
        ) : null}
      </Head>
